...
set SYSCFG_PATH="E:\MSOM0_workspace\sysconfig_cli.bat"
...
%SYSCFG_PATH% -o "%PROJ_DIR%.." -s "E:\MSOM0_workspace\mspm0_sdk_1_20_01_06\.metadata\product.json"--compiler keil "%PROJ_DIR%..\%SYSCFG_FILE%"
